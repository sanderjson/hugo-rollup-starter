(function (factory) {
  ...
  */
  ...
  var mutations = {
    ...
    togglePlay: function togglePlay(state, payload) {
  ...
  var pixiApp = function () {
    ...
    app.loader.add('bunny', 'bunny.png').load(function (loader, resources) {});

    var init = app.loader.onComplete.add(function () {
      ...
      var init = function () {
        ...
        storeInstance.subscribe(function () {
          for (var i = 0, list = container.children; i < list.length; i += 1) {
            var child = list[i];
