(function (factory) {
  ...
  */
  ...
  var ioHandleIntersect = function (entries) {
  ...
  var io = new IntersectionObserver(ioHandleIntersect, ioOptions);
  var canvasContainer = document.getElementById('canvasContainer');
